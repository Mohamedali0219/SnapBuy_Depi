    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CircleAvatar(
            ...
            backgroundColor: Colors.grey, // Placeholder color if image doesn't load
          ),

          SizedBox(height: 16),
          Text('Matilda Brown', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.shopping_cart), label: 'Bag'),
